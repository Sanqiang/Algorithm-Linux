...
public class QuestionB {
	...
	public static String printLongestWord(String arr[]) {
		...
		for (String s : arr) {
			if (canBuildWord(s, arr, true, map)) {
	...
	public static boolean canBuildWord(String str, String[] array, boolean isOriginalWord, HashMap<String, Boolean> map) {
		if (str == "") {
			return true;
		}
		...
		for (String s : array) {
			if (str.startsWith(s)) {
				boolean v = canBuildWord(str.substring(s.length()), array, false, map);
				map.put(str, v);
				if (v) {
					return true;
				}
