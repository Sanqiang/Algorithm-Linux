...
public class Rectangle {
    ...
    /* Construct an "empty" rectangular array of letters, of height 0
     * and length specified by the argument.
     */
     ...
     * and height. The array is initially filled with "zero" characters
     * ('\u0000'), by default.
     */
